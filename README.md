**A Bias Aware Multimodal Workflow for sSeed Zone Maps and Conservation of Vitellaria-Paradoxa** 
Author: Gabriel Salako, PhD	Affiliation: Senckenberg Museum of Natural History, Görlitz, Germany
...
**4.	Outputs**
The pipeline generates: ensemble suitability rasters (RF/BRT), Bayesian posterior means, partial dependence plots, ecological response curves, and SZPI maps. Figures are exported as PNG/GeoTIFF and can be used directly in decision support.
